          ...
          <div className="mx-auto max-w-2xl text-center lg:mx-0 lg:text-left">
            ...
            <div className="mt-9 flex flex-col items-center justify-center gap-4 sm:flex-row lg:justify-start">
              ...
              <a
                ...
                className="inline-flex h-14 w-full max-w-sm items-center justify-center overflow-hidden rounded-xl transition-all duration-200 hover:-translate-y-0.5 hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-offset-2 focus:ring-offset-slate-900 sm:w-auto"
              >
                <img
            ...
            <p className="mt-3 text-sm text-slate-300">
              Trackefy mobile app for parents and drivers
            </p>
          </div>
